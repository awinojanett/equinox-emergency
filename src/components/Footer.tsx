    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">Equinox Emergency College</span>
            </div>
            <p className="text-gray-400 mb-4">
              Leading the way in emergency medical training and education. Empowering healthcare
              professionals with the knowledge and skills they need to save lives.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Equinox Emergency College. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
